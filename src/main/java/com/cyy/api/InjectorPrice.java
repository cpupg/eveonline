 ...
 * <p>欧服脑浆价格。</p>
 * 
 * <p>初始化时会调用API查询欧服PLEX价格，预计国服开服后会加入国服API。</p>
 * 
 * 类中有以下参数：
 * <ul>
 * <li>volume：订单数量
...
public class InjectorPrice {
  ...
  /**
   * <p>默认构造函数，调用市场API获取技能注射器价格</p>
   * 
   * <p>获取的价格为伏尔戈星域价格。在后续计算中分别取平均价格和最低售价来计算需要的技能注射器
   * 的数量</p>
   */
  public InjectorPrice() {
    // 设置汇率
    buy = new Hashtable<String, String>();
    sell = new Hashtable<String, String>();
    CloseableHttpClient httpClient = HttpClients.createDefault();
    // 市场限制在伏尔戈星域
    HttpGet httpGet = new HttpGet("http://api.evemarketer.com/ec/marketstat?typeid=40520&regionlimit=10000002");
  ...
  public String toString() {
    return "InjetcoorPrice [buy=" + buy + ", sell=" + sell + "]";
  }
